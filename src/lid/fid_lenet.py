"""
From https://github.com/mbinkowski/MMD-GAN/blob/master/gan/compute_scores.py
"""
...
class LeNet(object):
    def __init__(self):
        MODEL_DIR = os.path.expanduser('~/lenet/savedmodel')
        self.softmax_dim = 10
        self.coder_dim = 512
...
def main():
    ...
    samples = np.load(args.samples, mmap_mode='r')['arr_0']
